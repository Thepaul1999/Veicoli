              ...
              <div data-gjs="navbar-items" className="navbar-items-c">
                <nav id="iccwch" className="navbar-menu-nav">
                  ...
                  {!isAdmin ? (
                    ...
                    <>
                      <Link href="/dashboard" id="ilink2" className="nav-links">
                        dashboard
                      </Link>
          ...
          >
            ...
            >
              <div data-type-icon="" id="iabt1icon" className="gjs-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="iyd0r">
                  <path
                    fill="none"
                    stroke="currentColor"
                    strokeLinecap="round"
            ...
            >
              <div data-type-icon="" id="iabt1icon-2" className="gjs-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="ihew1">
                  <path
                    fill="none"
                    stroke="currentColor"
                    strokeLinecap="round"
            ...
            >
              <div data-type-icon="" id="iabt1icon-2-2" className="gjs-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="imohs">
                  <path
                    fill="none"
                    stroke="currentColor"
                    strokeLinecap="round"
      ...
      <section id="ifeatures" className="gjs-section">
        <div id="iftcnt" className="gjs-container">
          ...
          <div
            ...
            className="gjs-plg-flex-row"
          >
            <div data-type-role="flex-column" id="ift1" className="gjs-plg-flex-column">
            ...
            <div data-type-role="flex-column" id="ift2" className="gjs-plg-flex-column">
            ...
            <div data-type-role="flex-column" id="ift3" className="gjs-plg-flex-column">
            ...
            <div data-type-role="flex-column" id="ift4" className="gjs-plg-flex-column">
            ...
            <div data-type-role="flex-column" id="ift5" className="gjs-plg-flex-column">
            ...
            <div data-type-role="flex-column" id="ift6" className="gjs-plg-flex-column">
      ...
      <section id="istats" className="gjs-section">
        <div id="istcnt" className="gjs-container">
          ...
          <div
            ...
            className="gjs-plg-flex-row"
          >
            <div data-type-role="flex-column" id="ist1" className="gjs-plg-flex-column">
              <h3 id="ist1num">50,000+</h3>
              <span id="ist1text">Active Users</span>
            </div>
            <div data-type-role="flex-column" id="ist2" className="gjs-plg-flex-column">
              <h3 id="ist2num">99.9%</h3>
              <span id="ist2text">Uptime Guarantee</span>
            </div>
            <div data-type-role="flex-column" id="ist3" className="gjs-plg-flex-column">
      ...
      <section id="ireviews" className="gjs-section">
        <div id="irevcnt" className="gjs-container">
          ...
          <div
            ...
            className="gjs-plg-flex-row"
          >
            <div data-type-role="flex-column" id="irev1" className="gjs-plg-flex-column">
              <img
              ...
              />
              <span id="irev1text">
                "CloudSync transformed how our team collaborates. The seamless
                integration and intuitive interface made adoption effortless across
            ...
            <div data-type-role="flex-column" id="irev2" className="gjs-plg-flex-column">
              <img
              ...
              />
              <span id="irev2text">
                "We've tried many collaboration tools, but CloudSync stands out
                with its reliability and comprehensive feature set. It's become
            ...
            <div data-type-role="flex-column" id="irev3" className="gjs-plg-flex-column">
              <img
              ...
              />
              <span id="irev3text">
                "The customer support is outstanding. Any questions we have are
                answered quickly, and the platform updates continuously improve our
                workflow efficiency."
              </span>
